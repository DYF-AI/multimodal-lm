...
if __name__ == "__main__":
    train_metadata_file = r"J:\dataset\mllm-data\mllm-finetune-data\trainticket\train\metadata.jsonl"
    test_metadata_file = r"J:\dataset\mllm-data\mllm-finetune-data\trainticket\test\metadata.jsonl"
    save_arrow_root = r"J:\dataset\mllm-data\mllm-finetune-data\trainticket"
