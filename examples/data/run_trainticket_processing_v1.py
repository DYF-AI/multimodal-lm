...
if __name__ == "__main__":
    train_metadata_file = r"J:\data\mllm-data\mllm-finetune-data\trainticket\train\metadata.jsonl"
    test_metadata_file = r"J:\data\mllm-data\mllm-finetune-data\trainticket\test\metadata.jsonl"
