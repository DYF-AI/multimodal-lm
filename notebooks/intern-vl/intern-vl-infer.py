...
pixel_values1 = load_image(image_file_1, max_num=12).to(torch.bfloat16).cuda()
pixel_values2 = load_image(image_file_2, max_num=12).to(torch.bfloat16).cuda()
...
video_path = 'N:/model/OpenGVLab/InternVL2-8B/examples/red-panda.mp4'
